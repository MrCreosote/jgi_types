...
module KBaseFile {
    ...
    */
    ...
    /* A library of paired end reads. If data is interleaved lib2 will be null
        or absent.
      lib1 - TODO - need accurate description here - is it expected that lib1
          is left reads and lib2 is right?
      lib2 - TODO - need accurate description here
      ...
      interleaved - whether the left and right reads are interleaved in a
          single file
      read_orientation_outward - TODO - need accurate description here
